...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : jeu. 05 jan. 2023 à 09:20
...
INSERT INTO `connexion` (`id_user`, `username`, `mdp`, `mail`) VALUES
(1, 'admin', 'admin', 'admin.jkmeteo@f2i.fr'),
(2, 'jojo', 'jojo', 'jojo.jkmeteo@f2i.fr'),
(4, 'Jokast', 'adminj', 'jokast38@gmail.com');
...
INSERT INTO `note` (`idn`, `note`, `id_user`, `username`) VALUES
(1, 8, 1, ''),
(2, 16, 1, ''),
(3, 18, 1, ''),
(4, 10, 4, ''),
